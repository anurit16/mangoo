...
function setup() {
	...
	//Create the Bodies Here.
      stone=new Stone(75,440,30);
      mango1=new Mango(700,200,10);
      mango2=new Mango(750,220,10);
      mango3=new Mango(780,280,10);
      mango4=new Mango(680,300,10);
      mango5=new Mango(650,200,10);
      mango6=new Mango(830,300,10);
      mango7=new Mango(1000,200,10);
      mango8=new Mango(900,210,10);
